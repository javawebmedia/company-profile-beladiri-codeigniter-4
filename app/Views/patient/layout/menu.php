    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url('patient/dasbor') ?>" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url('patient/booking') ?>" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url('patient/booking/history') ?>" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url('patient/akun') ?>" class="nav-link">
